...
<html>
	<head>
		...
		<!-- 
			DBCP(DataBase Connection Pool)
			 - 데이터베이스 접속 커넥션 객체를 미리 생성해서 Pool(저장소)에 저장해놓고 사용하는 방식
			...
			<Resource 
		    	...
		    	username="kggakm"							-- 데이터베이스 아이디
		    	password="1234"								-- 데이터베이스 비밀번호
		    	maxTotal="13"								-- 최대 커넥션풀에 생성되는 커넥션 개수
		    	maxIdle="13"								-- 활성화(준비된) 커넥션 개수
	...
	<body>
		...
		<a href="/ch05/user2/list.jsp">User2 목록</a>
		<a href="/ch05/user3/list.jsp">User3 목록</a>
		<a href="/ch05/user4/list.jsp">User4 목록</a>
		<a href="/ch05/user5/list.jsp">User5 목록</a>
